...
A Spring Boot REST API for managing financial accounts and processing transactions. This service handles account creation, balance validation, and transaction recording using an in-memory H2 database.
